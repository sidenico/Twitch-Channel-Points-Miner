...
func NewLogger(settings LoggerSettings, username string) *Logger {
	...
	return NewLoggerWithOutput(settings, output)
}

// NewLoggerWithOutput builds a logger that writes to the provided writer.
func NewLoggerWithOutput(settings LoggerSettings, output io.Writer) *Logger {
	if output == nil {
		output = io.Discard
	}
	return &Logger{
...
func DiscardLogger() *Logger {
	return NewLoggerWithOutput(LoggerSettings{}, io.Discard)
}
