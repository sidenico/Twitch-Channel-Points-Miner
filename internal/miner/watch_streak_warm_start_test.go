...
func testWarmStartStreamer(login, channelID, broadcastID string, createdAt time.Time, online bool) *streamer.Streamer {
...
func TestPickStreamersToWatchPersistsTimedOutStreakToWarmStartCache(t *testing.T) {
	...
	m.pickStreamersToWatch([]*streamerModel{streamer})
